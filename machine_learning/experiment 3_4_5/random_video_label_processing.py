...
# -*- coding: utf-8 -*-
"""
Created on Thu Feb  9 23:26:49 2023
...
video_label_type= ["random_anxiety_label"]
#"trans0", "trans10","trans20","trans30","trans10_onlybegin","trans20_onlybegin",
...
for num_feats in  num_feats_list:
    for c in  names:
       for label_type in video_label_type:
            df_event_features_trans= pd.read_csv("merged_processed_files2/"+label_type+"/ECG_RSP_Features"+c+".csv")
            ...
            df_feature_selector_trans.to_csv("feature_lists/"+ label_type+"_"+c+"features" +str(num_feats)+".csv")
            ...
            for n,name in enumerate(selector_names_trans):
                selector_names_trans[n]=selector_names_trans[n]+"_"+label_type+"_"+c+"_"+"features"+str(num_feats)
